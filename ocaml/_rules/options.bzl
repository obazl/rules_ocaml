...
def options_module(ws):
    ...
    if ws == "ocaml":
        ...
        providers = []
        # _module_deps_out_transition = ppx_module_deps_out_transition
...
def options_ns_resolver(ws):
    ...
    return dict(
        ...
        submodules = attr.string_list(
            doc = "Experimental. For building ns libs without ocaml_ns_library.",
        ),
...
def options_ns_library(ws):
    ...
    # if ws == "ocaml":
    #     main_transition_out_fn = ocaml_nslib_main_out_transition
    #     submodules_transition_out_fn = ocaml_nslib_submodules_out_transition
    #     ns_transition_out_fn = ocaml_nslib_ns_out_transition
    # else:
    #     main_transition_out_fn = ppx_nslib_main_out_transition
    #     submodules_transition_out_fn = ppx_nslib_submodules_out_transition
    #     ns_transition_out_fn = ppx_nslib_ns_out_transition
    ...
    # _ns_transition_out_fn = ocaml_nslib_ns_out_transition
    ...
    return dict(
        ...
        #     cfg = ns_transition_out_fn  ## outgoing
        # ),
        ...
        _ns_prefix   = attr.label(
            doc = "Experimental",
            default = ws_prefix + "//ns:prefix"
        ),
        # _ns_trace   = attr.label(
        #     doc = "Experimental",
        #     default = ws_prefix + "//ns:trace"
        # ),
        ...
        submodules = attr.label_list(
            ...
            cfg = _submodules_transition_out_fn
        ),

        sublibs = attr.label_list(
            doc = "List of *_ns_library submodules",
            allow_files = [".cmo", ".cmx", ".cmi"],
            providers   = _sublib_providers,
            # cfg = sublibs_transition_out_fn
        ),
