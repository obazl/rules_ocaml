...
########## RULE:  OCAML_PACK_MODULE  ################
def _ocaml_pack_module_impl(ctx):
  ...
  ctx.actions.run(
    ...
    progress_message = "ocaml_pack_module({}), {}".format(
...
#############################################
########## DECL:  OCAML_PACK_MODULE  ################
ocaml_pack_module = rule(
  implementation = _ocaml_pack_module_impl,
  attrs = dict(
    _sdkpath = attr.label(
