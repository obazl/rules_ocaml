...
load("//ocaml/_rules:ocaml_ns_env.bzl",
    _ocaml_ns_env = "ocaml_ns_env")
load("//ocaml/_rules:ocaml_ns_library.bzl",
...
load("//ocaml/_rules:ppx_ns_env.bzl",
    _ppx_ns_env = "ppx_ns_env")
load("//ocaml/_rules:ppx_ns_archive.bzl",
     _ppx_ns_archive = "ppx_ns_archive")
load("//ocaml/_rules:ppx_ns_library.bzl",
     _ppx_ns_library = "ppx_ns_library")
