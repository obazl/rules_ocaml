...
load("//ocaml/_rules:x_ocaml_module.bzl"      , _ocaml_module = "ocaml_module")
...
load("//ocaml/_rules:x_ocaml_ns.bzl"      , _ocaml_ns = "ocaml_ns")
# load("//ocaml/_rules:ocaml_ns_library.bzl"  , _ocaml_ns_library = "ocaml_ns_library")
load("//ocaml/_rules:x_ocaml_ns_library.bzl"  , _ocaml_ns_library = "ocaml_ns_library")
