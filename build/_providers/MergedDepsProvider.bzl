...
MergedDepsProvider, _new_ocamlocamlinfo = provider(
    ...
    fields = {
        ...
        "cli_link_deps" : "Depset of cm[x|o] files to be added to inputs and link cmd line (executables and archives).",
        "link_archives_deps" : "Depset of cm[x]a and cm[x|o] files to be added to inputs and link cmd line (executables and archives).",
