...
a custom label will set `-use-runtime`.
            """,
...
def options_aggregators():
    ...
    return dict(
        ...
        manifest = attr.label_list(
            doc = "List of component modules for libraries.",
            providers = [[OCamlArchiveProvider],
                         [OCamlImportProvider],
                         [OCamlLibraryProvider],
                         [OCamlModuleProvider],
...
"static": archive the library; "shared": build cmxs.
            """,
